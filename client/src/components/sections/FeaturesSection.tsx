    ...
    <section id="about" className="section section-odd">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Referral System */}
          <div className="bg-card rounded-xl p-6 border border-border shadow-md hover:shadow-lg hover:border-primary/30 transition-all duration-300">
          ...
          {/* Staking Vault */}
          <div className="bg-card rounded-xl p-6 border border-border shadow-md hover:shadow-lg hover:border-secondary/30 transition-all duration-300">
          ...
          {/* Leaderboard Rewards */}
          <div className="bg-card rounded-xl p-6 border border-border shadow-md hover:shadow-lg hover:border-accent/30 transition-all duration-300">
